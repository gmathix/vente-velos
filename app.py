...
from controllers.admin_velo import *
from controllers.admin_declinaison_velo import *
from controllers.admin_commande import *
from controllers.admin_type_velo import *
...
app.register_blueprint(client_velo)
...
app.register_blueprint(admin_velo)
app.register_blueprint(admin_declinaison_velo)
app.register_blueprint(admin_commande)
app.register_blueprint(admin_type_velo)
